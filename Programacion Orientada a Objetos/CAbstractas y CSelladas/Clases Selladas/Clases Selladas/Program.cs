...
namespace Clases_Selladas
{
    ...
    internal class Humano : Mamifero
    {
        ...
        //PONEMOS QUE PENSAR NO SE PUEDA SOBRESCRIBIR 
    ...
    //usando la palabra sealed antes de class sella la clase y no nos permite que esta herede en un futuro 
    sealed class chimpance : Gorilas
    {
    ...
    class adolescente : Humano
    {
        ...
        //ANDA A HUMANO ---- 
        /* TIRA ERROR PORQUE NO SE PUEDE SOBRESCRIBIR
        public override void pensar()
        {
            Console.WriteLine("NO PIENSO CON CLARIDAD");
        }
        */
    }
